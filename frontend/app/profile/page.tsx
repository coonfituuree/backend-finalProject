                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-6 border-t flex gap-4">
                    <button
                      ...
                      className="flex-1 cursor-pointer bg-[rgb(164,134,86)] text-white px-6 py-3 rounded-lg font-bold hover:opacity-90 transition">
                      Edit Profile
                    </button>

                    {user.role === "admin" && (
                      <button
                        className="flex-1 cursor-pointer bg-[linear-gradient(116.49deg,_rgb(28,43,79)_0%,_rgb(80,98,112)_100%)] text-white px-6 py-3 rounded-lg font-bold hover:opacity-90 transition"
                    ...
                    <button
                      ...
                      className="flex-1 cursor-pointer bg-[rgb(244,245,247)] border border-gray-200 text-[rgb(28,43,79)] px-6 py-3 rounded-lg font-bold hover:bg-gray-100 transition">
                      Logout
                    </button>
                  </div>
                </div>
