...
export default function PaymentPage() {
  ...
  const handlePayment = async (e: React.FormEvent) => {
    ...
    try {
      const result = await paymentApi.payBooking({
        bookingId: bookingId || "",
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="mb-6 pb-6 border-b">
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <p className="text-sm text-gray-600">{booking.flight.from}</p>
              </div>

              <div className="text-right">
                <p className="text-sm text-gray-600 font-semibold">Прибытие</p>
                <p className="text-2xl font-bold text-gray-800">
            ...
            <p className="text-sm text-gray-600">
              <strong>Дата:</strong> {formatDate(booking.flight.departureTime)}
            </p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-xl p-6">
          ...
          <div className="mt-6 pt-6 border-t">
            ...
            <p className="text-xs text-gray-600">Карта: 4111 1111 1111 1111</p>
